...
var mbema = {
  ...
  "answerWrong": {"eng": "Your answer was wrong. Would you like to try again?",
	...
	"thankYouThisPart": {"eng":"How difficult/easy did this task feel? Answer by moving the bar.",
	                     "fi":"Kuinka vaikealta/helpolta tämä tehtävä tuntui? Vastaa liikuttamalla palkkia."},
}

var singing = [
  [{"eng": "Singing task", 
   "fi": "Laulutehtävä"}],
  [{"eng": "<b>Welcome to the Singing task!</b><br><br>Press the Next button to continue.<br>Press the Home button to return to the starting screen<br><br>", 
    "fi": "<b>Tervetuloa Laulutehtävään!</b><br><br>Jatka painamalla Seuraava-nappia.<br>Palaa aloitusnäyttöön painamalla Alku-nappia<br><br>"}],
  [{"eng": 'In this task, you will need headphones. Put them on and connect them to your device.<br>Press the Play button to hear a test sound from your headphones.<br>Adjust the volume to comfortable level.<br>If there were issues with sound playback or you don\'t want to sing now, press Home button to return.<br>In the next page you must allow microphone usage to continue the singing test.<br><br><button class="jspsych-btn" style="margin:5vw;"><img src="././images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="testaudio.play()"></button>',
    "fi": 'Tässä tehtävässä tarvitset kuulokkeita. Laita ne päähäsi ja yhdistä laitteeseesi.<br>Paina Soita-nappia kuullaksesi testiäänen kuulokkeistasi.<br>Säädä äänenvoimakkuus itsellesi mukavaksi tietokoneen asetuksista.<br>Jos ääntä ei kuulu tai et halua nyt laulaa, voit palata aloitusnäyttöön painamalla Alku-nappia<br>Seuraavalla sivulla sinun pitää sallia mikrofonin käyttö sivulla tehdäksesi laulutestin.<br><br><button class="jspsych-btn" style="margin:5vw;"><img src="././images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="testaudio.play()"></button>'},],
	[{"eng": 'Please select the microphone you would like to use.<br><br>If you see only one selection, everything is fine.',
    "fi": 'Valitse mikrofoni, jota haluat käyttää alta.<br><br>Jos valintavaihtoehtoja on vain yksi, asia on jo kunnossa.'},
	{"eng": 'Select this microphone',
    "fi": 'Valitse tämä mikrofoni'}],
	[{"eng": "Let's check next that the microphone of your device and audio saving works.<br><br>Keep the device close to your mouth.<br><br>Press the Record button and then say “Singing is for everyone” with your normal speaking voice.",
    "fi": 'Tarkistetaan seuraavaksi, että laitteesi mikrofoni toimii ja äänen tallennus onnistuu.<br><br>Pidä laitetta lähellä suutasi.<br><br>Paina Tallenna-nappia ja sano sitten “Laulu kuuluu kaikille” normaalilla puheäänellä.'},
	{"eng":'Recording..<br><br><img src="./images/imagesSinging/rec-btn.svg" style="width:10vw;padding:5vw;"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>After you have sung the tone, wait a few seconds or press Next to continue.<br><br>',
	"fi":'Tallennetaan..<br><br><img src="./images/imagesSinging/rec-btn.svg" style="width:10vw;padding:5vw;"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>Kun olet laulanut sävelen, odota muutama sekunti tai jatka painamalla Seuraava.<br><br>'},
	{"eng":"Record again",
	...
	{"eng":'Recording..<br><br><img src="./images/imagesSinging/rec-btn.svg" style="width:10vw;padding:5vw;"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>After you have sung the melody, press Next to continue.<br><br>',
	"fi":'Tallennetaan..<br><br><img src="./images/imagesSinging/rec-btn.svg" style="width:10vw;padding:5vw;"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>Kun olet laulanut melodian, jatka painamalla Seuraava.<br><br>'},
	{"eng":'Recording..<br><br><img src="./images/imagesSinging/rec-btn.svg" style="width:10vw;padding:5vw;"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>After you have sung the song, press Next to continue.<br><br>',
	"fi":'Tallennetaan..<br><br><img src="./images/imagesSinging/rec-btn.svg" style="width:10vw;padding:5vw;"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>Kun olet laulanut laulun, jatka painamalla Seuraava.<br><br>'},
	...
	"fi":'Tallennetaan..<br><br><img src="./images/imagesSinging/rec-btn.svg" style="width:10vw;padding:5vw;"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>Kun olet sanonut lauseen, odota muutama sekunti tai jatka painamalla Seuraava.'}, 
	...
	"fi":'Tallennetaan..<br><br><img src="./images/imagesSinging/rec-btn.svg" style="width:10vw;padding:5vw;"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br><div id="counter">&nbsp;</div><br>Paljon onnea vaan<br>Paljon onnea vaan<br>Paljon onnea Hanna<br>Paljon onnea vaan<br><br>Kun olet laulanut laulun, jatka painamalla Seuraava.<br><br>'},
	{"eng":'Here you may listen to your voice recording.<br>If there are issues with the sound, press the Record again button and then say “Singing is for everyone” with your normal speaking voice.<br>You may also press the Home button to return to the starting screen<br><br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="recaudio.play()"></button><br><br>',
	"fi":'Tässä voit kuunnella äänityksesi.<br>Jos äänitys ei kuulosta hyvältä, paina Tallenna uudestaan -nappia ja sano “Laulu kuuluu kaikille” normaalilla puheäänellä.<br>Voit myös vielä palata aloitusnäyttöön painamalla Alku-nappia.<br><br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="recaudio.play()"></button><br><br>'},
	],
	...
	{"eng":"Child",
	"fi":"Lapsi"},
	{"eng":'By pressing the buttons below you will hear Happy Birthday sung from three vocal ranges (low, middle, high).<br><br><div id="jspsych-html-button-response-btngroup"><button class="jspsych-btn laulu-btn" style="margin:5vw;" onclick="mid_en.pause(); mid_en.currentTime=0; high_en.pause(); high_en.currentTime=0; low_en.play()">Low</button><button class="jspsych-btn laulu-btn" style="margin:5vw;" onclick="low_en.pause(); low_en.currentTime=0; high_en.pause(); high_en.currentTime=0; mid_en.play()">Middle</button><button class="jspsych-btn laulu-btn" style="margin:5vw;" onclick="low_en.pause(); low_en.currentTime=0; mid_en.pause(); mid_en.currentTime=0; high_en.play()">High</button></div>',
	"fi":'Alla olevia nappeja painamalla kuulet laulun Paljon onnea laulettuna kolmelta äänialalta (matala, keski, korkea).<br><br>Kokeile kaikkia ja laula mukana.<br><br><div id="jspsych-html-button-response-btngroup"><button class="jspsych-btn laulu-btn" style="margin:5vw;" onclick="mid_fi.pause(); mid_fi.currentTime=0; high_fi.pause(); high_fi.currentTime=0; low_fi.play()">Matala</button><button class="jspsych-btn laulu-btn" style="margin:5vw;" onclick="low_fi.pause(); low_fi.currentTime=0; high_fi.pause(); high_fi.currentTime=0; mid_fi.play()">Keski</button><button class="jspsych-btn laulu-btn" style="margin:5vw;" onclick="low_fi.pause(); low_fi.currentTime=0; mid_fi.pause(); mid_fi.currentTime=0; high_fi.play()">Korkea</button></div>'},
	...
	{"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing back.<br><br>Press the Play button to start<br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="testtone.play()"></button><br>After you have sung the tone, press Next to continue.',
    "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten perässä.<br><br>Aloita painamalla Soita-nappia.<br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="testtone.play()"></button><br>Kun olet laulanut sävelen, jatka painamalla Seuraava.'},
	...
	[{"eng":"Thank you for singing!<br><br>How difficult/easy did this task feel?<br><br>Answer by moving the bar.",
	"fi":"Kiitos laulustasi!<br><br>Kuinka vaikealta/helpolta tämä tehtävä tuntui?<br><br>Vastaa liikuttamalla palkkia."},
	{"eng":"difficult",
	"fi":"vaikea"},
	{"eng":"easy",
	"fi":"helppo"},
	...
	{"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing along.<br><br>Press the Play button to start<br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="testtonerep()"></button><br>After you have sung the tone, press Next to continue.<br><br>',
    "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten mukana.<br><br>Aloita painamalla Soita-nappia.<br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="testtonerep()"></button><br>Kun olet laulanut sävelen, jatka painamalla Seuraava.<br><br>'},
	...
	{"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing back.<br><br>Press the Play button to start<br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="testtone.play()"></button><br>After you have sung the melody, press Next to continue.',
    "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten perässä.<br><br>Aloita painamalla Soita-nappia.<br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" onclick="testtone.play()"></button><br>Kun olet laulanut melodian, jatka painamalla Seuraava.'},
	...
	{"eng":'The lyrics go like this:<br><br>How much time do we have left<br>How much time do we have left<br>How much time do we have left now<br>How much time do we have left<br><br><b>Listen</b> to the song once by pressing the Play button<br><br>Just focus on listening, do not sing along<br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" id="novsongbtn"  onclick="novsong_play()"></button>',
	"fi":'Laulun sanat menevät näin:<br><br>Kuinka paljon kello on<br>Kuinka paljon kello on<br>Kuinka paljon kello on nyt<br>Kuinka paljon kello on<br><br><b>Kuuntele</b> laulu kertaalleen painamalla Soita-nappia.<br><br>Keskity kuuntelemaan, älä laula mukana<br><button class="jspsych-btn" style="margin:5vw;"><img src="./images/imagesSinging/play-btn.svg" style="width:10vw;padding:5vw;" id="novsongbtn" onclick="novsong_play()"></button>'},
