...
var singing = [
  ...
  [{"eng": 'Please select the microphone you would like to use. If you see only one selection, everything is fine.',
    "fi": 'Valitse mikrofoni, jota haluat käyttää alta.Jos valintavaihtoehtoja on vain yksi, asia on jo kunnossa.'},
	{"eng": 'Select this microphone',
    "fi": 'Valitse tämä mikrofoni'}],
	[{"eng": "Let's check next that the microphone of your device and audio saving works.<br><br>Keep the device close to your mouth.Press the Record button and then say “Singing is for everyone” with your normal speaking voice.",
	...
	{"eng": "Recording ok, continue",
	"fi": "Tallennus ok, jatketaan"},
	{"eng":"Your microphone and audio saving are working!",
  ...
  {"eng":'<div id="recordingLabel">Recording..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>After you have sung the song, press Next to continue.<br>',
   "fi":'<div id="recordingLabel">Tallennetaan..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>Kun olet laulanut laulun, jatka painamalla Seuraava.<br>'},
  ...
  {"eng":'<div id="recordingLabel">Recording..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>After you have recorded the sentence, wait a few seconds or press Next to continue<br>',
   "fi":'<div id="recordingLabel">Tallennetaan..</div><img id="recButton" id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>Kun olet sanonut lauseen, odota muutama sekunti tai jatka painamalla Seuraava<br>'}, 
	{"eng":'Here you may listen to your voice recording.<br>If you wish to adjust your microphone, press the Record again button and then say “Singing is for everyone” with your normal speaking voice.',
  ...
  {"eng":'Here you may listen to your voice recording.<br>If there are issues with the sound, press the Record again button and then say “Singing is for everyone” with your normal speaking voice<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="recaudio.play()"><br><br>',
  "fi":'Tässä voit kuunnella äänityksesi.<br>Jos äänitys ei kuulosta hyvältä, paina Tallenna uudestaan -nappia ja sano “Laulu kuuluu kaikille” normaalilla puheäänellä.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="recaudio.play()"><br><br>'},
	...
	[{"eng":"Let's start with a short singing warm-up and see which vocal range is most comfortable for you to sing.",
	"fi":"Tehdään alkuun lyhyt lauluäänen lämmittely ja katsotaan, miltä äänialalta sinun on mukavin laulaa."}],
	[{"eng":"First let's select your voice type.<br><br>Are you a woman, man or child?<br><br>Select by pressing button.<br><br>",
	...
	{"eng":"Which vocal range felt most comfortable for you to sing?<br><br>Select by pressing button.<br><br>",
	...
	{"eng":"High",
	"fi":"Korkea"}],
	[{"eng":"In the next task, we ask you to <b>sing back</b> individual tones.<br><br>You will hear syllable “la” sung in specific pitch.<br><br>After hearing the syllable, sing it back as accurately as you can.<br><br>",
  ...
  {"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing back.<br><br>Press the Play button to start<br>After you have sung the tone, press Next to continue.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtone.play()">',
   "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten perässä.<br><br>Aloita painamalla Soita-nappia.<br>Kun olet laulanut sävelen, jatka painamalla Seuraava.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtone.play()">'},
	{"eng":'<b>Tone <span id="stimcounter"></span></b><br><br>Listen first and then sing back.<br><br>Press the Record button to start.',
	...
	[{"eng":"Thank you for singing!<br><br>How difficult/easy did this task feel?",
	...
	[{"eng":"In the next task, we ask you to <b>sing along</b> individual tones.<br><br>You will hear syllable “la” sung in specific pitch two times.<br><br>In the first time, focus on listening, do not sing.<br><br>In the second time, sing along as accurately as you can.<br><br>",
  ...
  {"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing along.<br><br>Press the Play button to start<br>After you have sung the tone, press Next to continue.<br> <img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtonerep()">',
  "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten mukana.<br><br>Aloita painamalla Soita-nappia.<br>Kun olet laulanut sävelen, jatka painamalla Seuraava.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtonerep()">'},
	{"eng":'<b>Tone <span id="stimcounter"></span></b><br><br>Listen first and then sing along.<br><br>Press the Record button to start.',
	...
	[{"eng":"In the next task, we ask you to <b>sing back</b> short melodies.<br><br>You will hear a short melody sung on syllable “la”.<br><br>After hearing the melody, sing it back as accurately as you can.<br><br>",
  ...
  {"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing back.<br><br>Press the Play button to start<br><br>After you have sung the melody, press Next to continue.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtone.play()">',
   "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten perässä.<br><br>Aloita painamalla Soita-nappia.<br><br>Kun olet laulanut melodian, jatka painamalla Seuraava.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtone.play()">'},
	{"eng":'<b>Melody <span id="stimcounter"></span></b><br><br>Listen first and then sing back.<br><br>Press the Record button to start.',
	...
	[{"eng":"In the next task, we ask you to <b>sing along</b> short melodies.<br><br>You will hear a short melody sung on syllable “la” two times.<br><br>In the first time,focus on listening, do not sing.<br><br>In the second time, sing along as accurately as you can.<br><br>",
	...
	{"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing along.<br><br>Press the Play button to start<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtonerep()"><br>After you have sung the melody, press Next to continue.',
	...
	{"eng":'<b>Melody <span id="stimcounter"></span></b><br><br>Listen first and then sing along.<br><br>Press the Record button to start.',
	...
	[{"eng":"In the next task, we ask you to <b>sing from memory</b> the Happy Birthday song.<br><br>The birthday hero is <b>Hannah</b> so sing this for her.<br><br>",
	...
	{"eng":"So the lyrics are:<br><br>Happy birthday to you<br>Happy birthday to you<br>Happy birthday dear Hannah<br>Happy birthday to you<br><br>When you are ready, press the Record button and start singing.",
	...
	[{"eng":"In the next task, we ask you to <b>sing along</b> the Happy Birthday song.<br><br>The birthday hero is <b>Hannah</b> so let's sing this for her.",
	...
	{"eng":"Next you will hear the song three times.<br><br><b>Sing along</b> as accurately as you can.<br><br>Press the Record button to start.",
	...
	[{"eng":"Singing task is now completed<br><br>Thank you for participating!<br><br>Press the Home button to return to the starting screen",
