...
var recurring = {
  ...
  "instruction15": {"eng": "Screen timeout > 30/15/10 minutes <br> <img id='instructionLock' src='./images/instructions/androidInstructions2.png'></img>",
                    "fi": "Näytön lukitus > 30/15/10 minuuttia <br> <img id='instructionLock' src='./images/instructions/androidInstructions2.png'></img>"},
...
var beatProduction = {
  ...
  "adjustBeat": {"eng": "Adjust the beat",
                    "fi": "Säädää tahtia"},
...
var initialInstructions = {
   "canYouHear": {"eng": "Can you hear this song? If so, adjust the volume to a comfortable hearing level and click Continue.<img id='tableSVG' src='./images/soundSVG.svg'>If you cannot hear the song, try changing to a different computer/phone or to a different internet browser.",
   ...
   "no": {"eng": "No",
          "fi": "Ei"},
   "gettingHelp": {"eng": "Is someone helping you to complete this task?",
                   "fi": "Auttaako joku sinua tämän tehtävän suorittamisessa?"},
   "canYouHear2": {"eng": "Can you hear this song? If yes, adjust the volume to a comfortable hearing level and click Next. Make sure that the 'mute' button on the left side of your phone is disabled. If it still doesn't work change to a different phone or to a different internet browser.",
   ...
   "idk": {"eng": "I don't know",
           "fi": "En tiedä"}
}

var sharedMeasurementsT = {
  ...
  "daily": {"eng": "daily",
            "fi": "päivittäin"},
  "prompt": {"eng": "Here are some statements about music perception. How do they apply to you? Select the option that best fits you",
             "fi": "Seuraavassa on muutamia väitteitä musiikin havaitsemisesta. Missä määrin ne sopivat sinuun? Valitse vaihtoehto, joka parhaiten kuvaa sinua."},
  "iCanTell": {"eng": "I can tell when people sing or play out of time with the beat",
       "fi": "Huomaan kun ihmiset laulavat tai soittavat väärässä tahdissa"},
  "iCanTellTune": {"eng": "I can tell when people sing or play out of tune",
       "fi": "Huomaan kun ihmiset laulavat tai soittavat epävireisesti"},
  "iFind": {"eng": "I find it difficult to spot mistakes in a performance of a song even if I know the tune",
       "fi": "Minun on vaikea havaita virheitä kappaleen esityksessä vaikka sävelmä olisi minulle tuttu"},
  "haveTrouble": {"eng": "I have trouble recognizing a familiar song when played in a different way or by a different performer",
       "fi": "Minun on hankala tunnistaa tuttu kappale kun se soitetaan eri tavalla tai eri esittäjä soittaa sen"},
  "whenISing": {"eng": "When I sing, I have no idea whether I'm in tune or not",
       "fi": "Laulaessani en tiedä lainkaan laulanko vireessä vai epävireessä"},
  ...
  "secondaryLanguage": {"eng": "What is your secondary spoken language? (If applicable)",
                        "fi": "Mikä on toissijainen puhuttu kielesi? (jos on)"},
  "yearOfBirth": {"eng": "Year of birth",
                  "fi": "Syntymävuosi"},
  "nationality": {"eng": "What is your nationality",
  ...
  "likeSinging": {"eng": "En pidä julkisesti laulamisesta, koska pelkään laulavani vääriä nuotteja.",
...
var tasksIcons = {
  ...
  "MBEMA": {
    "eng": "Music Perception",
    "fi": "Musiikin havaitsemistehtävään"
  },
  "rhythm": {
    "eng": "Rhythm",
    "fi": "Rytmi"
...
var emotionTranslations = {
  "openStatement": {"eng": "Music and Emotion Survey",
                    "fi": "Kysely musiikista ja tunteista"},
  "pleaseAnswer": {"eng": "Please, answer the following questions",
                   "fi": "Ole hyvä ja vastaa seuraaviin kysymyksiin"},
  "musicEmotionPart2": {"eng": "Music and Emotion part 2",
  ...
  "tender": {"eng": "Tender",
             "fi": "Hellyys"},
  "instructions1":{"eng": "Next, you will listen to clips of music. Please choose the emotion that the music expresses the most.",
                   "fi": "Seuraavaksi kuulet musiikkia. Valitse tunnetila, jota musiikki ilmaisee mielestäsi parhaiten."},
  "instructions2": {"eng": "You can practice once to get familiar with the task. Before starting, please adjust the volume to a comfortable level.",
  ...
  "instructions3": {"eng": "Thank you for your response! The practice is over, you can start the task by clicking Next",
                    "fi": "Kiitos vastauksista! Harjoitus on nyt ohi, ja voit aloittaa tehtävän painamalla Seuraava"},
  "whichEmotion": {"eng": "Which of these two emotions does the music express the most?",
                   "fi": "Mitä tunnetilaa musiikki ilmaisee parhaiten?"},
  "listen": {"eng": "Listen...",
             "fi": "Kuuntele…"},
  "instructions4": {"eng": "Next, listen to the clips of music and rate what they express in terms of mood, energy, and strength of emotions. You can start the task by clicking Next",
  ...
  "instructions5": {"eng": "Please rate what the music expresses",
                    "fi": "Arvioi, mitä musiikki ilmaisee"},
  "mood": {"eng": "Mood",
           "fi": "Tunnelita"},
  "energy": {"eng": "Energy",
             "fi": "Energisyys"},
  "howStrongEmotion": {"eng": "How strong are the emotions expressed by the music?",
                       "fi": "Kuinka voimakkaasti musiikki ilmaisee tunteita?"},
  "howMuchLike": {"eng": "How much did you like/dislike the music?",
                  "fi": "Kuinka paljon pidit/et pitänyt musiikista?"},
  "howFamiliar": {"eng": "How familiar did the music sound to you?",
                  "fi": "Kuinka tutulta musiikki kuulosti?"},
  "veryNegative": {"eng": "Very negative",
                   "fi": "Todella negatiivinen"},
  "negative": {"eng": "Negative",
               "fi": "Negatiivinen"},
  "positive": {"eng": "Positive",
               "fi": "Positiivinen"},
  "veryLowEnergy": {"eng": "Very low energy",
                    "fi": "Ei lankaan energinen"},
  "veryHighEnergy": {"eng": "Very high energy",
                     "fi": "Todella vahvasti energinen"},
  "rateEmotionalContent": {"eng": "Please rate the emotional content of the music",
                           "fi": "Arvioi musiikin herättämiä tunteita."},
  "notAtAll": {"eng": "Not at all",
               "fi": "Ei lainkaan"},
  "veryStrong": {"eng": "Very strong",
                 "fi": "Todella voimakkaita"},
  "stronglyDisliked": {"eng": "Strongly disliked",
                       "fi": "En pidä lainkaan"},
  "neutral": {"eng": "Neutral",
              "fi": "Neutraali"},
  "choose": {"eng": "Choose",
  ...
  "genderOption2":{
      "fi": "mies",
      "eng": "male"},
  "genderOption3": {"fi": "joku muu",
                    "eng": "other"},
  "genderOption4": {"fi": "en halua kertoa",
                    "eng": "prefer not to say"},
}

var mbema = {
   "welcome": {"eng": "Welcome to the Music perception task!",
               "fi": "Tervetuloa Musiikin havaitsemistehtävään!"},
   "taskConsists": {"eng": "The task consists of three parts and it takes about 15 min in total",
                    "fi": "Tehtävä koostuu kolmesta osiosta ja sen tekemiseen menee yhteensä noin 15 min"},
   "wholeTask": {"eng": "Please do the whole task in one session",
                 "fi": "Pyydämme, että teet koko tehtävän samalla kertaa"},
   "firstPart": {"eng": "In the first task part, you will hear a short signal tone followed by two successive melodies",
                 "fi": "Ensimmäisessä tehtäväosiossa kuulet lyhyen merkkiäänen ja sen jälkeen kaksi peräkkäistä melodiaa"},
   "firstPartB": {"eng": "The melodies are separated by a short break",
                  "fi": "Melodioiden välillä on lyhyt tauko"},
   "yourTask":  {"eng": 'Your task is to compare the two successive melodies and decide whether they sound the same or different',
                 "fi": 'Tehtäväsi on verrata kahta peräkkäistä melodiaa ja päättää, kuulostavatko ne samalta vai erilaisilta'},
   "yourTaskB":  {"eng": 'If you think that the melodies are the same, just press "Same". If you think that the melodies are different, press "Different"',
                  "fi": 'Jos melodiat ovat mielestäsi samat, paina "Sama". Jos melodiat ovat mielestäsi erilaiset, paina "Eri"'},
   "firstLets": {"eng": "First, let's do a couple of practice trials",
                 "fi": 'Otetaan aluksi pari harjoittelukierrosta'},
   "listen": {"eng": "Listen<br><img id='music' src='./images/music.svg'></img>",
              "fi": "Kuuntele<br><img id='music' src='./images/music.svg'></img>"},
   "thanksThird": {"eng": "Thank you for your answers! Let's do the third and final task part.",
                  "fi": "Kiitos vastauksistasi! Tehdään vielä kolmas ja viimeinen tehtäväosio."},
	 "previousParts": {"eng": "In the previous task parts, you have heard many melodies several times",
                    "fi": "Olet edellisissä tehtäväosioissa kuullut useita melodioita moneen kertaan"},
	 "previousPartsB": {"eng": "Next you will hear both previously presented melodies and entirely novel melodies.",
                      "fi": "Seuraavassa kuulet sekä aiemmin esitettyjä melodioita että täysin uusia melodioita."},
   "canYouTell": {"eng": 'Can you tell which melodies have already been presented to you and which ones are novel?',
                 "fi": 'Osaatko sanoa, mitkä melodiat on esitetty sinulle jo aiemmin ja mitkä ovat uusia?'},
   "canYouTellB": {"eng": 'When you have the feeling that you have heard the melody before, press the "Yes" button. Otherwise, press "No"',
                   "fi": 'Kun sinusta tuntuu, että olet kuullut melodian aikaisemmin, paina "Kyllä". Muutoin paina nappia "Ei"'},
   "firstCouple": {"eng": "First, let's do a couple of practice trials",
                  "fi": 'Otetaan aluksi pari harjoittelukierrosta'},
  "thankYouSimilar": {"eng": "Thank you for your answers! Let's continue with another similar task part.",
                      "fi": "Kiitos vastauksistasi! Jatketaan toisella samantyyppisellä tehtäväosiolla."},
  "youWillAgain": {"eng": 'You will again hear successive melodies and your task is to decide whether they sound the same or different.',
                   "fi": 'Kuulet jälleen perättäisiä melodioita ja sinun tulee päättää, kuulostavatko ne samalta vai erilaisilta'},
  "youWillAgainB": {"eng": 'If you think that the melodies are the same, just press "Same". If you think that the melodies are different, press "Different"',
                   "fi": 'Jos melodiat ovat mielestäsi samat, paina "Sama". Jos melodiat ovat mielestäsi erilaiset, paina "Eri"'},
  "firstPractice": {"eng": "First, let's do a couple of practice trials",
                    "fi": 'Otetaan aluksi pari harjoittelukierrosta'},
  "nowContinue": {"eng": "Now, let's continue with the actual task",
                  "fi": "Nyt jatketaan varsinaisella tehtävällä"},
  "nowContinueB": {"eng": "In the task, you will hear a total of 20 melody pairs",
                   "fi": "Tehtävässä tulee yhteensä 20 melodiaparia"},
  "nowContinueC": {"eng": "Listen carefully and decide if the melodies sound the same or different",
                   "fi": "Kuuntele tarkasti ja päätä, kuulostavatko melodiat samalta vai erilaiselta"},
  "totalOfTwenty": {"eng": "Now, let's continue with the actual task",
                    "fi": "Nyt jatketaan varsinaisella tehtävällä"},
  "totalOfTwentyB": {"eng": "In the task, you will hear a total of 20 melodies",
                    "fi": "Tehtävässä kuulet yhteensä 20 melodiaa"},
  "totalOfTwentyC": {"eng": "Listen carefully and answer if have you heard the melody before",
                    "fi": "Kuuntele tarkasti ja vastaa oletko kuullut melodian aiemmin."},
  "choose": {"eng": "Choose",
             "fi": "Valitse"},
  "heardBefore": {"eng": "Have you heard this melody before?",
                  "fi": "Oletko kuullut tämän melodian aikaisemmin?"},
  "answerWrong": {"eng": "Your answer was wrong. Would you like to try again?",
                  "fi": "Vastauksesi oli väärin. Haluatko kokeilla uudelleen?"},
	"difficult": {"eng":"difficult",
	              "fi":"vaikea"},
	"easy": {"eng":"easy",
	         "fi":"helppo"},
	"taskComplete": {"eng":"The task is now complete! Thank you for your participation. You will be redirected to the main page in a few seconds",
	                 "fi":"Tehtävä on nyt valmis! Kiitos osallistumisesta. Siirryt aloitusnäyttöön muutaman sekunnin päästä"},
	"thankYouThisPart": {"eng":"How difficult/easy did this task feel?",
	                     "fi":"Kuinka vaikealta/helpolta tämä tehtävä tuntui?"},
}

var singing = {
  "welcome": {"eng": "<b>Welcome to the Singing task!</b>", 
              "fi": "<b>Tervetuloa Laulutehtävään!</b>"},
  "inThisTask": {"eng": 'In this task, you will need headphones. Put them on and connect them to your device. Press the Play button to hear a test sound from your headphones.<br>Adjust the volume to comfortable level.<br>If there were issues with sound playback or you don\'t want to sing now, press Home button to return.<br>In the next page you must allow microphone usage to continue the singing test.<br><img id="playButton" src="././images/imagesSinging/play-btn.svg" onclick="testaudio.play()">',
                 "fi": 'Tässä tehtävässä tarvitset kuulokkeita. Laita ne päähäsi ja yhdistä laitteeseesi. Paina Soita-nappia kuullaksesi testiäänen kuulokkeistasi.<br>Säädä äänenvoimakkuus itsellesi mukavaksi tietokoneen asetuksista.<br>Jos ääntä ei kuulu tai et halua nyt laulaa, voit palata aloitusnäyttöön painamalla Alku-nappia<br>Seuraavalla sivulla sinun pitää sallia mikrofonin käyttö sivulla tehdäksesi laulutestin.<br><br><img id="playButton" src="././images/imagesSinging/play-btn.svg"  onclick="testaudio.play()">'},
  "pleaseSelect": {"eng": 'Please select the microphone you would like to use. If you see only one selection, everything is fine.',
                   "fi": 'Valitse mikrofoni, jota haluat käyttää alta.Jos valintavaihtoehtoja on vain yksi, asia on jo kunnossa.'},
	"selectThis": {"eng": 'Select this microphone',
                 "fi": 'Valitse tämä mikrofoni'},
  "letsCheck": {"eng": "Let's check next that the microphone of your device and audio saving works.<br><br>Keep the device close to your mouth.Press the Record button and then say “Singing is for everyone” with your normal speaking voice.",
                "fi": 'Tarkistetaan seuraavaksi, että laitteesi mikrofoni toimii ja äänen tallennus onnistuu.<br><br>Pidä laitetta lähellä suutasi.Paina Tallenna-nappia ja sano sitten “Laulu kuuluu kaikille” normaalilla puheäänellä.'},
	"recordAgain": {"eng":"Record again",
	                "fi":"Tallenna uudestaan"},
	"recordingOK": {"eng": "Recording ok, continue",
	                "fi": "Tallennus ok, jatketaan"},
	"yourMicrophone": {"eng":"Your microphone and audio saving are working!",
	                   "fi":"Mikrofoni ja äänen tallennus toimivat!"},
  "recording": {"eng":'<div id="recordingLabel">Recording..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>After you have sung the tone, wait a few seconds or press Next to continue.<br>',
                "fi":'<div id="recordingLabel">Tallennetaan..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>Kun olet laulanut sävelen, odota muutama sekunti tai jatka painamalla Seuraava.<br>'},
  "recording2": {"eng":'<div id="recordingLabel">Recording..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>After you have sung the melody, press Next to continue.<br>',
                 "fi":'<div id="recordingLabel">Tallennetaan..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>Kun olet laulanut melodian, jatka painamalla Seuraava.<br>'},
  "recording3": {"eng":'<div id="recordingLabel">Recording..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br><div id="counter">&nbsp;</div><br>How much time do we have left<br>How much time do we have left<br>How much time do we have left now<br>How much time do we have left<br><br>After you have sung along three times, press Next to continue.',
                 "fi":'<div id="recordingLabel">Tallennetaan..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br><div id="counter">&nbsp;</div><br>Kuinka paljon kello on<br>Kuinka paljon kello on<br>Kuinka paljon kello on nyt<br>Kuinka paljon kello on<br><br>Kun olet laulanut laulun kolme kertaa mukana, jatka painamalla Seuraava.'},
  "recording4": {"eng":'<div id="recordingLabel">Recording..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>After you have recorded the sentence, wait a few seconds or press Next to continue<br>',
                 "fi":'<div id="recordingLabel">Tallennetaan..</div><img id="recButton" id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br>Kun olet sanonut lauseen, odota muutama sekunti tai jatka painamalla Seuraava<br>'}, 
  "recording5": {"eng":'<div id="recordingLabel">Recording..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br><div id="counter">&nbsp;</div><br>Happy birthday to you<br>Happy birthday to you<br>Happy birthday dear Hannah<br>Happy birthday to you<br><br>After you have sung the song, press Next to continue.<br>',
                 "fi":'<div id="recordingLabel">Tallennetaan..</div><img id="recButton" src="./images/imagesSinging/rec-btn.svg"><br><div class="progress-light-grey jspsych-content" id="progbarcont" style="width:20vw;height:3vh;"><div class="progress-grey" id="progbar" style="width:0%;height:100%;"></div></div><br><div id="counter">&nbsp;</div><br>Paljon onnea vaan<br>Paljon onnea vaan<br>Paljon onnea Hanna<br>Paljon onnea vaan<br>Kun olet laulanut laulun, jatka painamalla Seuraava.<br>'},
  "hereYouMay": {"eng":'Here you may listen to your voice recording.<br>If you wish to adjust your microphone, press the Record again button and then say “Singing is for everyone” with your normal speaking voice.',
                 "fi":'Tässä voit kuunnella äänityksesi.<br>Jos haluat säätää mikrofoniasi, paina Tallenna uudestaan -nappia ja sano “Laulu kuuluu kaikille” normaalilla puheäänellä.'},
  "hereYouMay2": {"eng":'Here you may listen to your voice recording.<br>If there are issues with the sound, press the Record again button and then say “Singing is for everyone” with your normal speaking voice<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="recaudio.play()"><br><br>',
                  "fi":'Tässä voit kuunnella äänityksesi.<br>Jos äänitys ei kuulosta hyvältä, paina Tallenna uudestaan -nappia ja sano “Laulu kuuluu kaikille” normaalilla puheäänellä.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="recaudio.play()"><br><br>'},
	"shortSinging": {"eng":"Let's start with a short singing warm-up and see which vocal range is most comfortable for you to sing.",
	                 "fi":"Tehdään alkuun lyhyt lauluäänen lämmittely ja katsotaan, miltä äänialalta sinun on mukavin laulaa."},
  "firstLetsType": {"eng":"First let's select your voice type.<br><br>Are you a woman, man or child?<br><br>Select by pressing button.<br><br>",
	                  "fi":"Ensin valitaan äänityyppisi.<br><br>Oletko nainen, mies vai lapsi?<br><br>Valitse painamalla nappia.<br><br>"},
	"woman": {"eng":"Woman",
	          "fi":"Nainen"},
	"man": {"eng":"Man",
	        "fi":"Mies"},
	"child": {"eng":"Child",
	          "fi":"Lapsi"},
	"byPressing": {"eng":'By pressing the buttons below you will hear Happy Birthday sung from three vocal ranges (low, middle, high).<br><br><div id="jspsych-html-button-response-btngroup"><button class="jspsych-btn laulu-btn" onclick="mid_en.pause(); mid_en.currentTime=0; high_en.pause(); high_en.currentTime=0; low_en.play()">Low</button><button class="jspsych-btn laulu-btn" onclick="low_en.pause(); low_en.currentTime=0; high_en.pause(); high_en.currentTime=0; mid_en.play()">Middle</button><button class="jspsych-btn laulu-btn" onclick="low_en.pause(); low_en.currentTime=0; mid_en.pause(); mid_en.currentTime=0; high_en.play()">High</button></div>',
	               "fi":'Alla olevia nappeja painamalla kuulet laulun Paljon onnea laulettuna kolmelta äänialalta (matala, keski, korkea).<br><br>Kokeile kaikkia ja laula mukana.<br><br><div id="jspsych-html-button-response-btngroup"><button class="jspsych-btn laulu-btn" onclick="mid_fi.pause(); mid_fi.currentTime=0; high_fi.pause(); high_fi.currentTime=0; low_fi.play()">Matala</button><button class="jspsych-btn laulu-btn" onclick="low_fi.pause(); low_fi.currentTime=0; high_fi.pause(); high_fi.currentTime=0; mid_fi.play()">Keski</button><button class="jspsych-btn laulu-btn" onclick="low_fi.pause(); low_fi.currentTime=0; mid_fi.pause(); mid_fi.currentTime=0; high_fi.play()">Korkea</button></div>'},
	"whichRange": {"eng":"Which vocal range felt most comfortable for you to sing?<br><br>Select by pressing button.<br><br>",
	               "fi":"Mikä ääniala tuntui sinusta mukavimmalta laulaa?<br><br>Valitse painamalla nappia.<br><br>"},
	"low": {"eng":"Low",
	        "fi":"Matala"},
	"mild": {"eng":"Mid",
	         "fi":"Keski"},
	"high": {"eng":"High",
	         "fi":"Korkea"},
	"singBack": {"eng":"In the next task, we ask you to <b>sing back</b> individual tones.<br><br>You will hear syllable “la” sung in specific pitch.<br><br>After hearing the syllable, sing it back as accurately as you can.<br><br>",
	             "fi":"Seuraavassa tehtävässä pyydämme sinua <b>laulamaan perässä</b> yksittäisiä säveliä.<br><br>Kuulet tavun ”la” laulettuna tietyltä korkeudelta.<br><br>Tavun kuultuasi laula se perässä niin tarkasti kuin pystyt.<br><br>"},
  "practiceRound": {"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing back.<br><br>Press the Play button to start<br>After you have sung the tone, press Next to continue.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtone.play()">',
                    "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten perässä.<br><br>Aloita painamalla Soita-nappia.<br>Kun olet laulanut sävelen, jatka painamalla Seuraava.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtone.play()">'},
  "toneFirst": {"eng":'<b>Tone <span id="stimcounter"></span></b><br><br>Listen first and then sing back.<br><br>Press the Record button to start.',
                "fi":'<b>Sävel <span id="stimcounter"></span></b><br><br>Kuuntele ensin ja laula sitten perässä.<br><br>Aloita painamalla Tallenna-nappia.'},
	"thankSingingDifficult": {"eng":"Thank you for singing!<br><br>How difficult/easy did this task feel?",
	                             "fi":"Kiitos laulustasi!<br><br>Kuinka vaikealta/helpolta tämä tehtävä tuntui?"},
  "difficult": {"eng":"difficult",
                 "fi":"vaikea"},
  "easy": {"eng":"easy",
            "fi":"helppo"},
	"singAlongIndividual": {"eng":"In the next task, we ask you to <b>sing along</b> individual tones.<br><br>You will hear syllable “la” sung in specific pitch two times.<br><br>In the first time, focus on listening, do not sing.<br><br>In the second time, sing along as accurately as you can.<br><br>",
	                        "fi":"Seuraavassa tehtävässä pyydämme sinua <b>laulamaan mukana</b> yksittäisiä säveliä.<br><br>Kuulet tavun ”la” laulettuna tietyltä korkeudelta kahteen kertaan.<br><br>Ensimmäisellä kerralla keskity kuuntelemaan, älä laula.<br><br>Toisella kerralla laula mukana niin tarkasti kuin pystyt.<br><br>"},
  "listenFirstPractice": {"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing along.<br><br>Press the Play button to start<br>After you have sung the tone, press Next to continue.<br> <img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtonerep()">',
                          "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten mukana.<br><br>Aloita painamalla Soita-nappia.<br>Kun olet laulanut sävelen, jatka painamalla Seuraava.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtonerep()">'},
  "toneListenFirst": {"eng":'<b>Tone <span id="stimcounter"></span></b><br><br>Listen first and then sing along.<br><br>Press the Record button to start.',
                      "fi":'<b>Sävel <span id="stimcounter"></span></b><br><br>Kuuntele ensin ja laula sitten mukana.<br><br>Aloita painamalla Tallenna-nappia.'},
  "nextTaskSingBack": {"eng":"In the next task, we ask you to <b>sing back</b> short melodies.<br><br>You will hear a short melody sung on syllable “la”.<br><br>After hearing the melody, sing it back as accurately as you can.<br><br>",
	                          "fi":"Seuraavassa tehtävässä pyydämme sinua <b>laulamaan perässä</b> lyhyitä melodioita.<br><br>Kuulet tavulla ”la” lauletun lyhyen melodian.<br><br>Melodian kuultuasi laula se perässä niin tarkasti kuin pystyt.<br><br>"},
  "practiceMelody": {"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing back.<br><br>Press the Play button to start<br><br>After you have sung the melody, press Next to continue.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtone.play()">',
                          "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten perässä.<br><br>Aloita painamalla Soita-nappia.<br><br>Kun olet laulanut melodian, jatka painamalla Seuraava.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtone.play()">'},
  "melodyListenFirst": {"eng":'<b>Melody <span id="stimcounter"></span></b><br><br>Listen first and then sing back.<br><br>Press the Record button to start.',
                             "fi":'<b>Melodia <span id="stimcounter"></span></b><br><br>Kuuntele ensin ja laula sitten perässä.<br><br>Aloita painamalla Tallenna-nappia.'},
  "shortMelodySing": {"eng":"In the next task, we ask you to <b>sing along</b> short melodies.<br><br>You will hear a short melody sung on syllable “la” two times.<br><br>In the first time,focus on listening, do not sing.<br><br>In the second time, sing along as accurately as you can.<br><br>",
                      "fi":"Seuraavassa tehtävässä pyydämme sinua <b>laulamaan mukana</b> lyhyitä melodioita.<br><br>Kuulet tavulla ”la” lauletun lyhyen melodian kahteen kertaan.<br><br>Ensimmäisellä kerralla keskity kuuntelemaan, älä laula.<br><br>Toisella kerralla laula mukana niin tarkasti kuin pystyt.<br><br>"},
  "practiceShortMelody": {"eng": 'Let\'s start with a practice round.<br><br>Listen first and then sing along.<br><br>Press the Play button to start<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtonerep()"><br>After you have sung the melody, press Next to continue.',
                          "fi": 'Otetaan alkuun harjoittelukierros.<br><br>Kuuntele ensin ja laula sitten mukana.<br><br>Aloita painamalla Soita-nappia.<br><img id="playButton" src="./images/imagesSinging/play-btn.svg" onclick="testtonerep()"><br>Kun olet laulanut melodian, jatka painamalla Seuraava.'},
  "listenFirstShortMelody": {"eng":'<b>Melody <span id="stimcounter"></span></b><br><br>Listen first and then sing along.<br><br>Press the Record button to start.',
                             "fi":'<b>Melodia <span id="stimcounter"></span></b><br><br>Kuuntele ensin ja laula sitten mukana.<br><br>Aloita painamalla Tallenna-nappia.'},

	"nextTaskHappyBirthday": {"eng":"In the next task, we ask you to <b>sing from memory</b> the Happy Birthday song.<br><br>The birthday hero is <b>Hannah</b> so sing this for her.<br><br>",
	                          "fi":"Seuraavassa tehtävässä pyydämme sinua <b>laulamaan muistista</b> Paljon onnea -laulun.<br><br>Syntymäpäiväsankari on <b>Hanna</b>, joten laula tämä hänelle.<br><br>"},
	"lyricsAre": {"eng":"So the lyrics are:<br><br>Happy birthday to you<br>Happy birthday to you<br>Happy birthday dear Hannah<br>Happy birthday to you<br><br>When you are ready, press the Record button and start singing.",
	              "fi":"Laulun sanat siis ovat:<br><br>Paljon onnea vaan<br>Paljon onnea vaan<br>Paljon onnea Hanna<br>Paljon onnea vaan<br><br>Kun olet valmis, paina Tallenna-nappia ja ala laulamaan."},
	"nextTaskSingAlongHappyBirthday": {"eng":"In the next task, we ask you to <b>sing along</b> the Happy Birthday song.<br><br>The birthday hero is <b>Hannah</b> so let's sing this for her.",
                                     "fi":"Seuraavassa tehtävässä pyydämme sinua <b>laulamaan mukana</b> Paljon onnea -laulun.<br><br>Syntymäpäiväsankari on <b>Hanna</b>, joten lauletaan tämä hänelle."},
  "lyricsAreSingAlong": {"eng":"So the lyrics are:<br><br>Happy birthday to you<br>Happy birthday to you<br>Happy birthday dear Hannah<br>Happy birthday to you<br><br>When you are ready, press the Record button and start singing.",
                         "fi":"Laulun sanat siis ovat:<br><br>Paljon onnea vaan<br>Paljon onnea vaan<br>Paljon onnea Hanna<br>Paljon onnea vaan<br><br>Kun olet valmis, paina Tallenna-nappia ja ala laulamaan."},

	"finalTask": {"eng":"In the final task, let's learn to sing a <b>novel song</b>.",
	              "fi":"Viimeisessä tehtävässä opetellaan laulamaan <b>uusi laulu</b>."},
  "theLyricsGoLike": {"eng":'The lyrics go like this:<br><br>How much time do we have left<br>How much time do we have left<br>How much time do we have left now<br>How much time do we have left<br><br><b>Listen</b> to the song once by pressing the Play button<br><br>Just focus on listening, do not sing along<br><img class="playButton" src="./images/imagesSinging/play-btn.svg" id="novsongbtn" onclick="novsong_play()">',
                      "fi":'Laulun sanat menevät näin:<br><br>Kuinka paljon kello on<br>Kuinka paljon kello on<br>Kuinka paljon kello on nyt<br>Kuinka paljon kello on<br><br><b>Kuuntele</b> laulu kertaalleen painamalla Soita-nappia.<br><br>Keskity kuuntelemaan, älä laula mukana<br><img class="playButton" src="./images/imagesSinging/play-btn.svg" id="novsongbtn" onclick="novsong_play()">'},
  "nextHearThreeTimes": {"eng":"Next you will hear the song three times.<br><br><b>Sing along</b> as accurately as you can.<br><br>Press the Record button to start.",
                         "fi":"Seuraavaksi kuulet laulun kolme kertaa.<br><br><b>Laula mukana</b> niin tarkasti kuin pystyt.<br><br>Aloita painamalla Tallenna-nappia."},
	"endSinging": {"eng":"Singing task is now completed<br><br>Thank you for participating!<br><br>Press the Home button to return to the starting screen",
	               "fi":"Laulutehtävä on nyt ohi.<br><br>Kiitos osallistumisestasi!<br><br>Palaa aloitusnäyttöön painamalla Alku-nappia"},
}
