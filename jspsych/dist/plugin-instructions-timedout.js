var jsPsychInstructionsTimedout = (function (jspsych) {
  'use strict';
   ...
   */
  class InstructionsTimedoutPlugin {
      constructor(jsPsych) {
      ...
      trial(display_element, trial) {
          ...
          function show_current_page() {
              ...
              if (trial.show_clickable_nav) {
                  ...
                  nav_html +=
                      "<button id='jspsych-instructions-next' class='jspsych-instructions-btn'" +
  ...
  InstructionsTimedoutPlugin.info = info;

  return InstructionsTimedoutPlugin;
