...
def createBeat(segundosSegment, beats, shiftN, beat, name, repetitions):
    ...
    bar.export(f"./softSandBeats/{name}_{shiftN}.wav", format="wav")
...
frames = 360 #Number of frames within excerpt

segundosSegment = frames/sr #How many seconds does the whole segment have
segundosBeat = segundosSegment/beats

repetitions = beats*19 #How many repetitions for each segment should the output have
