...
var recurring = {
  ...
  "1": {"eng": "Welcome!",
        "fi": "Tervetuloa!"},
  "2": {"eng": "When you are ready to begin, click next", 
  ...
  "8": {"eng": "Continue",     //New
        "fi": "Jatka"},        //New
  "9": {"eng": "When you are ready to continue, click next", 
...
var beatProduction = {
  ...
  "1": {"eng": "Adjust the beat",
        "fi": "Säädää tahtia"},
  "3": {"eng": "In this task, you will hear a song which has a click track on top of it",
        "fi": "Tässä tehtävässä kuulet laulun jonka päällä on kilikkiraita"},
  "14": {"eng": "The click track sounds like this:",
        "fi": "Kilikkiraita kuulostaa tältä"},
  "4": {"eng": "The beat of the song and the click track may or may not be aligned with each other", 
        "fi": "Laulu ja kilikkiraita ovat joko samassa tahdissa tai eri tahdissa"},
  "2": {"eng": "Next, some examples",
        "fi": "Seuravassa pari esimerkki"},
  "5": {"eng": "Your task is to adjust the click track until it sounds that it is aligned with the song", 
        "fi": "Terhävä si on säätää kilikkiraita kunnes se on kuulostaa korvaasi olevan samassa tahdissa laulun kanssa"},
  "6": {"eng": "Press the left button if the click is too late or the right button if is too early",
  ...
  "11": {"eng": "On the next page, adjust the click by pressing the arrows. When you have found the best alignment, click 'continue'",
        "fi": ""},
  "12": {"eng": "Ok, let's continue with the task",
        "fi": "Selvä, jatketaan varsinaisellä tehtävällä"},
  "15": {"eng": "Next you will hear 6 songs. Align the click track with the beat of the song",
