var movement = [
  ...
  [{"eng": "In the next task, you will hear a song", 
         "fi": "Seuravassa tehtävässä kuulet laulun"},
  ...
  {"eng": "Move to the song in way that feels natural to you", 
...
var beatProduction = [
  {"eng": "Welcome to the Beat alignment task",
        "fi": ""},
  {"eng": "Adjust the beat",
        "fi": "Säädää tahtia"},
  ...
  {"eng": "The click track sounds like this:",
